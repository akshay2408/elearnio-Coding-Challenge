...
RSpec.describe "Talents", type: :request do
  ...
  describe "POST talents#create" do
    ...
    it "should create new talent with valid attributes" do
      post '/talents', :params => talents.first.to_json, :headers => { "Content-Type": "application/json" }
  ...
  describe "PUT talents#update" do
    ...
    it "should update the bio" do
      ...
      put "/talents/#{talents.first.id}", :params => new_talent_params.to_json, :headers => { "Content-Type": "application/json" }
      json = JSON.parse(response.body)
  ...
  describe "DELETE talents#destroy" do
    ...
    it 'removes talent from table' do
      delete "/talents/#{talents.first.id}", :params => talents.first.to_json, :headers => { "Content-Type": "application/json" }
      json = JSON.parse(response.body)
